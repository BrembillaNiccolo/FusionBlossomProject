...
KERNEL_NAME :=QECBLOSSOM
KERNEL_FUNCTION := resolve
TARGET := sw_emu
JOBS := 8
VPP_LDFLAGS :=
include ./utils.mk
...
HOST_SRCS += HostCode/common/xcl2.cpp HostCode/hostStart.cpp
...
KERN_SRCS += KernelCode/kernel.cpp
...
$(TEMP_DIR)/$(KERNEL_NAME).xo: KernelCode/kernel.cpp
	mkdir -p $(TEMP_DIR)
...
##########################################
testVARS:
	@echo v++ -c $(VPP_FLAGS) $(VPP_CFLAGS) -t $(TARGET) --platform $(PLATFORM) -k resolve --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' $(KERN_SRCS)
